...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>EduTrack - Dar-e-Arqam</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
        <meta content="Themesbrand" name="author" />
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('frontend/assets/images/triphub.png') }}">
      

        <link href="{{ asset('frontend/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('frontend/assets/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
        ...
        <!-- preloader css -->
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/preloader.min.css') }}" type="text/css" />
...
<!-- pace js -->
<script src="{{ asset('frontend/assets/libs/pace-js/pace.min.js') }}"></script>
...
<script src="{{ asset('frontend/assets/js/app.js') }}"></script>
    ...
    <!-- Plugins js-->
    <script src="{{ asset('frontend/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js') }}"></script>
    <!-- dashboard init -->
