    ...
    <div class="page-wrapper">
        ...
        <nav class="sidebar-wrapper">
            ...
            <div class="sidebar-brand">
                <a href="#" class="logo">
                    <img src="{{ asset('assets/images/logo.svg') }}" alt="Max Admin Dashboard" />
                </a>
            </div>
            <!-- Sidebar brand starts -->
                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="data-tables.html" class="current-page">Data Tables</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="main-container">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Data Tables</li>
                </ol>
                <!-- Breadcrumb end -->
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow">
                            <div class="dropdown-item">
                                <div class="d-flex py-2 border-bottom">
                                    <img src="{{ asset('assets/images/user.png') }}" class="img-4x me-3 rounded-3" alt="Admin Theme" />
                                    <div class="m-0">
                            ...
                            <div class="dropdown-item">
                                <div class="d-flex py-2 border-bottom">
                                    <img src="{{ asset('assets/images/user2.png') }}" class="img-4x me-3 rounded-3" alt="Admin Theme" />
                                    <div class="m-0">
                                        <h6 class="mb-1">Sophie Michiels</h6>
                            ...
                            <div class="dropdown-item">
                                <div class="d-flex py-2">
                                    <img src="{{ asset('assets/images/user3.png') }}" class="img-4x me-3 rounded-3" alt="Admin Theme" />
                                    <div class="m-0">
                                        <h6 class="mb-1">Sophie Michiels</h6>
                        ...
                        <li class="dropdown d-none d-md-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mini" aria-labelledby="countries">
                                <div class="country-container">
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('assets/images/flags/1x1/us.svg') }}" alt="Google Dashboards" />
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/flags/1x1/us.svg') }}" alt="Admin Panels" />
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/flags/1x1/us.svg') }}" alt="Modern Dashboards" />
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/flags/1x1/us.svg') }}" alt="Best Admin Dashboards" />
                                    </a>
                                </div>
                            </div>
                        </li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row gx-3">
                        <div class="col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Vertical Scroll</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Hiding Search Field</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
